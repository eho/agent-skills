...
When you run `gh issue list --state open --label "user-story" --limit 1` and find **no open issues**, you must signal the end of the loop.
...
*Action:*
1. Run `gh issue list --state open --label "user-story" --limit 1`. Returns Issue #12: "Add priority selector".
