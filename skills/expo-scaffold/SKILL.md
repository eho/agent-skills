...
3. Check the current Expo stable release using official Expo docs or `create-expo-app` output. Do not use `next`, beta, or canary templates unless the user explicitly asks.
