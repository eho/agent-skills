...
| [**Public Repo Explorer**](./public-repo-explorer/SKILL.md) | Local | Instructs the agent on how to efficiently browse public GitHub repositories using a local shallow clone. |
